...
<div class="wpmake-user-avatar-container">
	...
	?>
	<h4> <?php esc_html_e( 'User Avatar Upload', 'wpmake-user-avatar' ); ?></h4>
		...
		<div class="button-group">
			<div class="wpmake-user-avatar-upload">
				<p class="form-row " id="profile_pic_url_field" data-priority="">
					<span class="wpmake-user-avatar-upload-node" >
					...
					if ( ! $profile_picture_url ) {
						?>
							<button type="button" class="button wpmake-user-avatar-remove hide-if-no-js" style="display:none"><?php esc_html_e( 'Remove', 'wpmake-user-avatar' ); ?></button>
						<?php
						if ( isset( $options['capture_picture'] ) && $options['capture_picture'] ) {
							?>
							<button type="button" class="button wpmake_user_avatar_take_snapshot hide-if-no-js"><?php esc_html_e( 'Take Picture', 'wpmake-user-avatar' ); ?></button>
							<?php
						}
						?>
							<button type="button" class="button wpmake_user_avatar_upload hide-if-no-js"><?php esc_html_e( 'Upload file', 'wpmake-user-avatar' ); ?></button>
						<?php
					} else {
						?>
							<button type="button" class="button wpmake-user-avatar-remove hide-if-no-js"><?php esc_html_e( 'Remove', 'wpmake-user-avatar' ); ?></button>

							<?php
							if ( isset( $options['capture_picture'] ) && $options['capture_picture'] ) {
								?>
							<button type="button" class="button wpmake_user_avatar_take_snapshot hide-if-no-js" style="display:none"><?php esc_html_e( 'Take Picture', 'wpmake-user-avatar' ); ?></button>
								<?php
							}
							?>
							<button type="button" class="button wpmake_user_avatar_upload hide-if-no-js" style="display:none"><?php esc_html_e( 'Upload file', 'wpmake-user-avatar' ); ?></button>
						<?php
					}
					?>
				</p>
