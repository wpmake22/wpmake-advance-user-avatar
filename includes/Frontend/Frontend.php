...
class Frontend {
	...
	public function load_scripts() {
		...
		wp_enqueue_script( 'wpmake-sweetalert2', WPMAKE_USER_AVATAR_ASSETS_URL . '/js/sweetalert2/sweetalert2.min.js', array( 'jquery' ), '10.16.7', false );
		...
		wp_enqueue_style( 'wpmake-sweetalert2', WPMAKE_USER_AVATAR_ASSETS_URL . '/css/sweetalert2/sweetalert2.min.css', array(), '10.16.7' );
		...
		wp_localize_script(
			...
			array(
				...
				'wpmake_user_avatar_uploading'             => esc_html__( 'Uploading...', 'wpmake-user-avatar' ),
				'wpmake_user_avatar_something_wrong'       => esc_html__( 'Something wrong, please try again.', 'wpmake-user-avatar' ),
